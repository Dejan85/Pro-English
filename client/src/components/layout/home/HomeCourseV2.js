      ...
      <div className="homeCourseV2__container">
        ...
        <div className="homeCourseV2__right">
          ...
          <p className="homeCourseV2__p">
            onec pede justo, fringilla, aliquet nec, vulputatee egerdiet erdiett
            arcu. In justo, rhoncus ut, imperdiet a, venenatis vitaerdiet erde
            justo. llam dictum felis eu pede mollis pretium diet a, venenatis
            vita sto. Nullam dictum felis eu pede mollis pretiumdiet a,
            venenatis ie ust. ullam dictum felis eu pedemol iumpretium ieta...
          </p>
