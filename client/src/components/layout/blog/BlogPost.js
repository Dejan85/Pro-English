      ...
      <div className='blogPost'>
        ...
        <div className='blogPost__content'>
          ...
          <p className='blogPost__content__p'>
            ...
            Amerike u kojoj u ovom trenutku živi 40 miliona stranaca. Na čuveno
            ostrvo Elis sa još poznatijim Kipom slobode (Lady Liberty), pravo na
            njujorško tle su se iskrcali čuveni bezdomnici - u stvari raseljena
            lica i kosmopolite - poput Alberta Ajnštajna (iz Austrije), Levija
            Štrausa (iz Nemačke, tvorac čuvenih levis farmerki),Vladimira
            Nabokova (iz Rusije), Oskara de la Rente (iz Dominikanske Republike)
            i naših Nikole Tesle, Milutina Milankovića, Mihajla Pupina. Došli su
            i ostali kako bi ostvarili svoj američki san - i uspeli su u tome.
            Njihove životne priče i dan danas inspirišu ljude i hrabre ih da se
          ...
          <p className='blogPost__content__p'>
            ...
            istorijskih previranja. Danas živimo u miru i uvek težimo ka boljem
            i želimo više. Mišljenja su različita: oni koji ostaju tumače
            odlazak kao pametan potez, izdaju otadžbine ili uzaludan pokušaj:
            čovek od sebe ne može pobeći i sve svoje probleme nosi sa sobom; s
            druge strane, oni koji su otišli srećni su, uglavnom, jer su se
          ...
          <p className='blogPost__content__p'>
            ...
            Srbiju napustio ceo jedan Beograd. Slična situacija sa odlascima je
            i u drugim zemljama bivše Jugoslavije. Medju jačim dijasporama
            bivših jugoslovenskih zemalja je ona u Australiji koja broji preko
            200.000 Srba, 50.000 onih koji su u Australiju došli iz Bosne i
          ...
          <p className='blogPost__content__p'>
            ...
            i Adelajd, a pri vrhu liste godinama unazad stoji Melburn
            zahvaljujući najvišim ocenama u oblasti zdravstva, obrazovanja i
            infrastrukture. Regionalna Australija poslednjih godina doživljava
          ...
          <p className='blogPost__content__p'>
            ...
            zarada je preko 4000 evra, što je dovoljno za normalan život. Uzmite
          ...
          <p className='blogPost__content__p'>
            ...
            poslom u Australiji traje kratko bez obzira na vašu struku: posla
            ima i za one koji rade fizičke poslove, kao i za visokokvalifikovane
            radnike iz sektora kao što su medicina ili inženjerstvo. Australija
            je poznata po svojoj otvorenosti prema drugim narodima i rado
            prihvata različitost. Multikulturalnost je ponos Australije i njena
            lepota se ogleda u bogatom kulturnom životu, hrani, običajima i
          ...
          <p className='blogPost__content__p'>
            ...
            ulicu nije rizičan kao što je postao u Evropi poslednjih godina.
            Takodje, Australijanci su medju retkim, blagoslovenim, nacijama koje
            žive u miru i bez stresa, ne znajući ko je premijer države, niti
            koje su vladajuće stranke. Za politiku ne ostaje previše vremena u
          ...
          <p className='blogPost__content__p'>
            ...
            Australija zemlja sa najdužim životnim vekom. Prosečna starost
            Australijanaca je 84 godine. U Australiji možete da vršite
            fotosintezu, izbacujući negativnu energiju i proslavljajući Novu
            godinu na nekoj od australijskih plaža, na obali okeana, uz roštilj
            i hladno piće, u društvu ljudi iz celog sveta koji ne sude o drugima
            na osnovu mesta u kome su rodjeni. Umesto zaključka, jer kako da
            stavimo tačku na jednu priču kakva je Australija: šta vi mislite, da
